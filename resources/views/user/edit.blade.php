                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="user_name" class="col-md-4 col-form-label text-md-right">{{ __('ニックネーム') }}</label>

                                <div class="col-md-6">
                                    <input id="user_name" type="text" class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ $authUser->user_name }}" required autocomplete="user_name" autofocus>
